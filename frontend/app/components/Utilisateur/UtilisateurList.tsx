...
import {RoleUtilisateur, Utilisateur} from '@app/types/utilisateur';
            ...
            <table className="min-w-full bg-white">
                ...
                {utilisateurs.map((utilisateur) => (
                    ...
                    >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                <span
                    className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${getRoleBadgeColor(utilisateur.role)}`}>
                  {utilisateur.role}
                </span>
                        </td>
